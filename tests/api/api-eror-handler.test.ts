...
describe('ApiErrorHandler', () => {
  describe('checkResponse', () => {
    it('should not throw for successful response', () => {
      ...
      expect(() => ApiErrorHandler.checkResponse(response)).not.toThrow();
    });
    ...
    it('should throw error for failed response', () => {
      ...
      expect(() => ApiErrorHandler.checkResponse(response)).toThrow(
  ...
  describe('getErrorMessage', () => {
    ...
    it('should return default message for non-Error values', () => {
      const result = ApiErrorHandler.getErrorMessage('Some error');
